...
try{
    ...
    while (resultSet.next()) {
        ...
        String UpdateQuery = "update products SET price="+price+" , name='"+pdt_name+"', description='"+description+"',category_id='"+resultSet.getString("category_id")+"' WHERE product_id ="+pdt_id+"  ;";
